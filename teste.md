...
```
[ Fila Cirúrgica ] --(Critérios Oficiais de Priorização)--> [ Busca Ativa / Confirmação Prévia ]
                                                                      │
                                                           (Status: Confirmado)
                                                                      ▼
[ Desfecho Cirúrgico ] ◀── [ Confirmação via JWT ] ◀── [ Auto-preenchimento / Alocação ] ◀── [ Agenda Mensal ]
```
...
**Print:** ![Fila Principal](file:///C:/Users/lucas/.gemini/antigravity-ide/brain/e447f760-6cb3-4613-93a0-97f2b971244c/dashboard_main_1781699399434.png)
...
**Print:** ![Detalhes da Agenda de Oftalmologia](file:///C:/Users/lucas/.gemini/antigravity-ide/brain/e447f760-6cb3-4613-93a0-97f2b971244c/agenda_details_1781699447497.png)
...
**Print:** ![Relatório de Auto-preenchimento](file:///C:/Users/lucas/.gemini/antigravity-ide/brain/e447f760-6cb3-4613-93a0-97f2b971244c/autofill_report_1781699556704.png)
...
**Print:** ![Pasted Text Token](file:///C:/Users/lucas/.gemini/antigravity-ide/brain/e447f760-6cb3-4613-93a0-97f2b971244c/pasted_text_1781699707669.png)

**Descrição:**
A imagem captura a tela de simulação onde o sistema gera o link para o paciente. O link gerado possui o formato de destino `/confirmar-cirurgia?token=ey...` contendo uma chave criptografada em padrão JWT.

**Funcionalidade demonstrada:**
Mecanismo de geração e distribuição de links mágicos para confirmação ativa do paciente.
...
**Print:** ![Portal do Paciente](file:///C:/Users/lucas/.gemini/antigravity-ide/brain/e447f760-6cb3-4613-93a0-97f2b971244c/after_link_click_1781699644487.png)

**Descrição:**
A imagem exibe a interface pública que o paciente visualiza ao acessar o link em seu smartphone. Em uma folha de estilo limpa e focada, a tela traz o cabeçalho institucional do HULW/EBSERH, saúda o paciente, informa que sua cirurgia está pré-agendada e apresenta o resumo dos dados cruciais: especialidade, cirurgia indicada, data e intervalo estimado de horário, local e instruções pré-operatórias detalhadas (jejum absoluto, documentos necessários, horário de chegada). Abaixo, há dois botões de ação: "Confirmar Cirurgia" e "Recusar Cirurgia".
...
3. **Drag-and-Drop do Grid:** Completar a movimentação interativa de cards na agenda para reordenamento visual de horários em tempo real.
4. **Motor Prescritivo Avançado:** Utilizar inteligência artificial para agrupar cirurgias por afinidade de instrumental esterilizado e otimização de tempo de higienização de salas.
